...
it('ab-e-tc-001p: Регистрация !Тест не завершен: требуется автоматически получать код из СМС!', async () => {
...
it.only('ab-e-tc-003p: Добавление карты !Тест не завершен: требуется автоматически получать код из СМС!', async () => {
...
it('ab-e-tc-004p: Редактирование карты', async () => {
  /** > базовые тесты... <
...
// await driver.pause(5000);
  ...
  await HCardM.cardViewFrontName.waitForDisplayed({timeout: GenM.waitTime + 15000});
...
it('ab-e-tc-007p: Идентификация в MyID !-1-Тест не завершен: требуется эмулировать сканирование лица камерой устройства. -2-Иногда MyId открывается на английском!', async () => {
  /** > базовые тесты (см. файл ...) <
