...
describe('ab-ts-02p: Testing of operations | Тестирование операций |вер.20230913| /Тестов 6 (частично 3)/', () => {
...
it('ab-e-tc-05.001p: ! Transfer from card to card | Перевод с карты на карту /Тест выполнен частично: требуется автоматически получать код из СМС/', async () => {
  /** > базовые тесты (см. файл ...) <
