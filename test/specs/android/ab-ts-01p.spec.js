...
describe('ab-ts-01p: Тестирование обеспечения операций |вер.20230913| /Тестов 6 (частично 3)/', () => {
...
it.skip('ab-u-tc-01.001p: Выбор языка', async () => {
...
it.skip('ab-u-tc-01.002p: ? Контакты /Тест выполнен частично: -1-Вызов отсутствует в меню, -2-Telegram является каналом.../', async () => {
  /**
  Parameters
...
it('ab-e-tc-02.001p: ! Регистрация /Тест выполнен частично: требуется автоматически получать код из СМС/', async () => {
/** > базовые тесты (см. файл ТК 1 (Регистрация)):
   * - 2 Стр. выбор языка, выбор языка (Русский) (ш?: П.1)
...
it('ab-e-tc-02.002p: Авторизация', async () => {
/** > базовые тесты (см. файл ТК 1 (Регистрация)):
...
it('ab-e-tc-03.001p: ! Идентификация в MyID /Тест выполнен частично: -1-требуется эмулировать сканирование лица камерой устройства; -2-иногда MyId открывается на английском/', async () => {
...
it.skip('ab-u-tc-03.002p: Выбор языка', async () => {
  /** > базовые тесты (см. файл ...) <
